...
export default function NavBar() {
  ...
  return (
    <div>
      <nav className="bg-transparent border-b border-gray-200 py-2.5 fixed top-0 w-full z-50">
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
          ...
          {/* Contact Button and Burger/Close */}
          <div className="flex items-center lg:order-2">
            <a
              href="#contact"
              className="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 py-2 focus:outline-none"
            >
              Contact
            </a>
            <button
          ...
          {/* Mobile Menu */}
          <div
            className={`w-full lg:flex lg:w-auto lg:order-1 ${menuOpen ? '' : 'hidden'}`}
            id="mobile-menu"
          >
